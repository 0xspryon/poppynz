...
import { and, desc, eq, gt, isNull, lte, ne, or, type InferInsertModel, type InferSelectModel } from "drizzle-orm";
...
export class ApprovalRepo extends Context.Tag("@repo/db/ApprovalRepo")<
  ApprovalRepo,
  {
    ...
    listExpiringForNotification: (now: Date, until: Date) => Effect.Effect<Array<ApprovalExpiryCandidate>, SqlError>;
    markExpiryNotified: (id: string, stamps: ApprovalExpiryNotifiedStamps) => Effect.Effect<Approval, SqlError | DBNotFoundError>;
  }
>() { }
