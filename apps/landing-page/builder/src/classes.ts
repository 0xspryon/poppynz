...
const defs: Record<string, CssMap> = {
  ...
  "ftr-bottom": { desktop: `display:flex;flex-wrap:wrap;gap:12px;justify-content:space-between;align-items:center;margin-top:48px;padding-top:24px;border-top-width:1.5px;border-right-width:0;border-bottom-width:0;border-left-width:0;border-style:solid;border-color:${v("line")};${BODY};font-size:13px;color:${v("muted")}` },
  ...
  hdr: { desktop: `position:sticky;inset-block-start:0;z-index:20;display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:12px;column-gap:24px;padding:14px clamp(24px,5vw,96px);border-bottom-width:1.5px;border-top-width:0;border-right-width:0;border-left-width:0;border-style:solid;border-color:${v("line")};background-color:rgba(247,249,255,.94);backdrop-filter:blur(8px)` },
