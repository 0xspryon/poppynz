...
export class ProviderSearchRepo extends Context.Tag('@repo/db/ProviderSearchRepo')<
  ProviderSearchRepo,
  {
    findCandidateByUserId: (
      userId: string
    ) => Effect.Effect<ProviderSearchCandidate, SqlError | DBNotFoundError>;
    listCandidatesByUserIds: (
      userIds: Array<string>
    ) => Effect.Effect<Array<ProviderSearchCandidate>, SqlError>;
...
export const makeProviderSearchRepoTest = (
  implementation: Context.Tag.Service<ProviderSearchRepo>
