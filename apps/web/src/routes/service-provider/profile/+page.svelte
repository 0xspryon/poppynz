...
<svelte:head>
	<title>Profile · Poppynz</title>
</svelte:head>

<div class="mx-auto max-w-3xl">
	<h1 class="text-2xl font-bold text-base-content lg:text-[26px]">Your profile</h1>
	<p class="mt-1 mb-6 text-sm text-base-content-muted">
		Contact details, location & bio — families see this first.
	</p>
		...
		>
			...
			<fieldset class="fieldset mt-4">
				...
				<textarea
					...
					maxlength="512"
					bind:value={shortBio}
					placeholder="Tell families about your experience and what you love helping with."
				></textarea>
