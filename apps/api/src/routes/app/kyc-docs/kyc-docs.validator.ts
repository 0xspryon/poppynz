...
export const validateKycDocumentTypeCreateInput = validateInput(kycDocumentTypeCreateSchema, kycDocTypeValidationError);
export const validateKycDocumentTypeUpdateInput = validateInput(kycDocumentTypeUpdateSchema, kycDocTypeValidationError);
export const validateKycDocumentSubmitInput = validateInput(kycDocumentSubmitSchema, kycDocValidationError);
export const validateKycDocumentExpiryUpdateInput = validateInput(kycDocumentExpiryUpdateSchema, kycDocValidationError);
