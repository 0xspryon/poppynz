...
export const validateServiceNeededCreateInput = validateInput(serviceNeededCreateSchema, servicesNeededValidationError);
export const validateServiceNeededUpdateInput = validateInput(serviceNeededUpdateSchema, servicesNeededValidationError);
