...
Remaining named deviations: none beyond the ones already listed below (hero poster, async web fonts, `deco`'s missing `pointer-events:none`, French header two-line wrap at 1280px). No new deviations were introduced by this fix wave.
